<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LastFive.aspx.cs" MasterPageFile="~/Site.Master" Inherits="StudentsRating.Start" %>
...
runat="server">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DBSFinal %>" SelectCommand="SELECT TOP (5) WITH TIES [UniqId] as '№ зачетной книжки', [Name] as 'ФИО', [Rating] as 'Балл', [LessonDate] as 'Дата занятия', [LessonDescription] as 'Описание занятия' FROM [Students] WHERE ([Rating] IS NOT NULL) ORDER BY [Rating] ASC"></asp:SqlDataSource>
